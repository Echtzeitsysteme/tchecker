...
public:
  ...
  */
  std::size_t operator()(tchecker::algorithms::zg_couvscc::node_t const & n) const;
};
...
public:
  ...
  */
  bool operator()(tchecker::algorithms::zg_couvscc::node_t const & n1,
...
protected:
  ...
  */
  virtual void attributes(tchecker::algorithms::zg_couvscc::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void attributes(tchecker::algorithms::zg_couvscc::edge_t const & e, std::map<std::string, std::string> & m) const;
...
class generalized_algorithm_t
    : public tchecker::algorithms::couvscc::generalized_algorithm_t<tchecker::zg::zg_t,
                                                                    tchecker::algorithms::zg_couvscc::graph_t> {
public:
  using tchecker::algorithms::couvscc::generalized_algorithm_t<
      tchecker::zg::zg_t, tchecker::algorithms::zg_couvscc::graph_t>::generalized_algorithm_t;
};
...
public:
  using tchecker::algorithms::couvscc::single_algorithm_t<tchecker::zg::zg_t,
                                                          tchecker::algorithms::zg_couvscc::graph_t>::single_algorithm_t;
};
