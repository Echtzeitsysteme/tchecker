...
public:
  ...
  same discrete part
  */
  std::size_t operator()(tchecker::algorithms::zg_covreach::node_t const & n) const;
};
...
public:
  ...
  */
  bool operator()(tchecker::algorithms::zg_covreach::node_t const & n1,
...
class graph_t : public tchecker::graph::subsumption::graph_t<
                    tchecker::algorithms::zg_covreach::node_t, tchecker::algorithms::zg_covreach::edge_t,
                    tchecker::algorithms::zg_covreach::node_hash_t, tchecker::algorithms::zg_covreach::node_le_t> {
public:
  /*!
   \brief Constructor
   \param zg : zone graph
  ...
  */
  ...
  using tchecker::graph::subsumption::graph_t<
      tchecker::algorithms::zg_covreach::node_t, tchecker::algorithms::zg_covreach::edge_t,
      tchecker::algorithms::zg_covreach::node_hash_t, tchecker::algorithms::zg_covreach::node_le_t>::attributes;
...
protected:
  ...
  */
  virtual void attributes(tchecker::algorithms::zg_covreach::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void attributes(tchecker::algorithms::zg_covreach::edge_t const & e, std::map<std::string, std::string> & m) const;
...
public:
   ...
   */
  tchecker::algorithms::zg_covreach::graph_t & graph();

private:
  tchecker::ts::state_space_t<tchecker::zg::zg_t, tchecker::algorithms::zg_covreach::graph_t>
...
*/
class algorithm_t
    : public tchecker::algorithms::covreach::algorithm_t<tchecker::zg::zg_t, tchecker::algorithms::zg_covreach::graph_t> {
public:
  using tchecker::algorithms::covreach::algorithm_t<tchecker::zg::zg_t, tchecker::algorithms::zg_covreach::graph_t>::algorithm_t;
};
