...
algorithm_return_value::algorithm_return_value(tchecker::clock_id_t no_of_virt_clocks) : 
...
algorithm_return_value::algorithm_return_value(algorithm_return_value& other) : _contradictions(other._contradictions), _check(other._check) { };

algorithm_return_value::algorithm_return_value(
...
bool algorithm_return_value::contradiction_free() 
{
...
algorithm_return_value::get_contradictions() 
{
...
algorithm_return_value::get_check() 
{
  return std::make_shared<tchecker::strong_timed_bisim::visited_map_t>(_check);
}

void algorithm_return_value::add_to_contradictions(tchecker::virtual_constraint::virtual_constraint_t& to_add)
{
...
void algorithm_return_value::add_to_contradictions(std::shared_ptr<tchecker::virtual_constraint::virtual_constraint_t> to_add)
{
  this->add_to_contradictions(*to_add);
}

void algorithm_return_value::add_to_contradictions(tchecker::zone_container_t<tchecker::virtual_constraint::virtual_constraint_t>& to_add){
...
void algorithm_return_value::add_to_contradictions(std::shared_ptr<tchecker::zone_container_t<tchecker::virtual_constraint::virtual_constraint_t>> to_add){
  this->add_to_contradictions(*to_add);
}

void algorithm_return_value::add_to_check(tchecker::zg::state_sptr_t first, tchecker::zg::state_sptr_t second)
{
