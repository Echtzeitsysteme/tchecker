...
\begin{itemize}
    ...
    \item The \texttt{tchecker.ova} file downloaded from the GitHub Action.
\end{itemize}
...
\label{ex:}
All examples are located in the directory \texttt{/home/tchecker/tchecker\_code/examples}. 
...
\begin{enumerate}
    ...
    \item Use \texttt{tchecker} to analyze the generated \texttt{.tck} file (\href{https://github.com/ticktac-project/tchecker/wiki/Using-TChecker}{https://github.com/ticktac-project/tchecker/wiki/Using-TChecker}).
\end{enumerate}

Each example consists of a shell script and a \texttt{.txt} file. The shell script generates a \texttt{.tck} file, which is used as input for \texttt
{tchecker}.
